# STM32 USB Type-C Connector System Software Interface (UCSI) Middleware Library MCU Software Component
...
This **stm32-mw-usbpd-ucsi** MCU component repository provides the **USBPD UCSI middleware**, a USB Type-C Connector System Software Interface (UCSI) for STM32 microcontrollers.
